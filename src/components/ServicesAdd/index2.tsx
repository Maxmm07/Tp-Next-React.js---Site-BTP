    ...
    return (
      <Container maxW={'5xl'} py={12} mt={5}>
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
          <Stack spacing={4}>
            <Heading>Services de Rénovation</Heading>
            <Text color={'gray.500'} fontSize={'lg'}>
            Notre service de rénovation BTP redonne vie à vos bâtiments anciens et fatigués. Que ce soit pour votre maison ou votre entreprise.</Text>
            <Stack
              spacing={4}
              divider={
